...
export const getOrders = (reqData) => {
  ...
  return async (dispatch) => {
    ...
    try {
      const response = await ordersApi.get(`/api/admin/orders/`);
...
export const shipOrder = (orderId) => {
  return async (dispatch) => {
    try {
      ...
      const { data } = await ordersApi.put(`/api/admin/orders/${orderId}/ship`);
...
export const cancelOrder = (orderId) => async (dispatch) => {
  ...
  try {
    const response = await ordersApi.put(`/api/admin/orders/${orderId}/cancel`);
    const data = response.data;
...
export const deleteOrder = (orderId) => {
  return async (dispatch) => {
    ...
    try {
      const { data } = await ordersApi.delete(
...
//   try {
//     const response = await ordersApi.post(`/api/admin/orders/`, order);
//     const data = response.data;
